...
| Тесты API | Пройдены | 15 из 15 тестов: права, публикация, PII в обращениях, multipart-upload, rate limit и demo-media. |
...
- [ ] Добавить удаление аккаунта в iOS и Android и подтверждение владения адресом до исполнения веб-запроса на удаление.
