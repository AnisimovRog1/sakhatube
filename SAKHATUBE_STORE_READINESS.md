...
| Тесты API | Пройдены | 18 из 18 тестов: права, публикация, подтверждённое удаление, почтовая доставка, PII в обращениях, multipart-upload, rate limit и demo-media. |
...
- [ ] Добавить viewer-auth с защищёнными сессиями.
...
- [ ] Подключить выбранный почтовый сервис, секрет и домен отправителя на Railway; затем добавить удаление аккаунта в iOS и Android.
