...
| Тесты API | Пройдены | 17 из 17 тестов: права, публикация, подтверждённое удаление, PII в обращениях, multipart-upload, rate limit и demo-media. |
...
- [ ] Подключить почтовую доставку ссылки подтверждения и добавить удаление аккаунта в iOS и Android.
